            ...
            >
              <div className="p-6">
                ...
                <div className="flex justify-center mb-4 h-48 items-center">
                  {getMotherboardImage(motherboard.brand, motherboard.model) ? (
                    <img
                      src={getMotherboardImage(motherboard.brand, motherboard.model)}
                  ...
                  <div
                    ...
                    style={{
                      display: getMotherboardImage(motherboard.brand, motherboard.model) ? 'none' : 'flex',
                      color: colors.platinum
                    }}
                  >
                    <BsMotherboard size={64} style={{ color: colors.platinum }} />
