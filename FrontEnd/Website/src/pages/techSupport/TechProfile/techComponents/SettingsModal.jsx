...
const SettingsModal = ({ initialSettings, onClose, onSave, onDeleteAccount }) => {
  ...
  const notificationSettings = [
    ...
    { key: 'newRequestAlerts', label: 'New Request Alerts' },
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              ...
              <div 
                ...
                style={{ backgroundColor: colors.mainBeige }}
              >
                <span style={{ color: colors.mainBlack }}>Show Contact Info Publicly</span>
                <label className="relative inline-block w-12 h-6 cursor-pointer">
                  <input
                    type="checkbox"
                  ...
                  <div 
                    className="w-full h-full rounded-full transition-colors"
                    style={{ backgroundColor: settings.showContactInfo ? colors.mainYellow : colors.platinum }}
                  >
                    <div 
                      className="absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform"
                      style={{ 
                        transform: settings.showContactInfo ? 'translateX(24px)' : 'translateX(0)'
                      }}
                    />
                  </div>
                </label>
