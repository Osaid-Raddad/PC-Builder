...
import { FiMail, FiPhone, FiMapPin, FiCalendar, FiEdit, FiTrash2 } from 'react-icons/fi';
import BounceCard from '../../../../components/animations/BounceCard/BounceCard';
import colors from '../../../../config/colors';

const ProfileHeader = ({ userData, onEditClick, onDeleteAccountClick }) => {
  return (
    <BounceCard>
      <div 
      ...
      >
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-3xl font-bold mb-2" style={{ color: colors.mainBlack }}>
              {userData.name}
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm" style={{ color: colors.jet }}>Joined {userData.joinDate}</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6">
              <div className="text-center">
                <p className="text-2xl font-bold" style={{ color: colors.mainYellow }}>
                  {userData.stats.builds}
                </p>
                <p className="text-sm" style={{ color: colors.jet }}>Builds</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold" style={{ color: colors.mainYellow }}>
                  {userData.stats.favorites}
                </p>
                <p className="text-sm" style={{ color: colors.jet }}>Favorites</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold" style={{ color: colors.mainYellow }}>
