...
export default function PeripheralsScreen({ navigation }) {
  ...
  const handleCompareToggle = (product) => {
    if (isInCompare(product.id)) {
      ...
      if (category && category !== 'peripherals') {
        Alert.alert(
          "Different Category",
      ...
      addToCompare(product, 'peripherals');
      Alert.alert(
        "Added to Compare",
        ...
        <View style={styles.detailsRow}>
          ...
          {item.connection && (
            <View style={styles.detailItem}>
              ...
              <Text style={styles.detailValue}>{item.connection}</Text>
            </View>
          )}
        </View>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <MaterialCommunityIcons name="keyboard-outline" size={28} color={colors.mainYellow} />
            <Text style={styles.headerTitle}>Peripherals</Text>
          </View>
          <View style={{ width: 24 }} />
        </View>
        ...
        <Text style={styles.resultsCount}>
          {filteredPeripherals.length} Products Found
        </Text>

        {/* Products List */}
        <FlatList
          data={filteredPeripherals}
          renderItem={renderPeripheralCard}
